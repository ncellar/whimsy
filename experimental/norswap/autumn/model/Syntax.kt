...
val char_any
    get() = ParameterlessBuilder("char_any")

// -------------------------------------------------------------------------------------------------

val alpha
    get() = ParameterlessBuilder("alpha")

// -------------------------------------------------------------------------------------------------

val aphanum
    get() = ParameterlessBuilder("alphanum")

// -------------------------------------------------------------------------------------------------

val digit
    get() = ParameterlessBuilder("digit")

// -------------------------------------------------------------------------------------------------

val hex_digit
    get() = ParameterlessBuilder("hex_digit")

// -------------------------------------------------------------------------------------------------

val octal_digit
    get() = ParameterlessBuilder("octal_digit")

// -------------------------------------------------------------------------------------------------

val space_char
    get() = ParameterlessBuilder("space_char")

// -------------------------------------------------------------------------------------------------

val java_iden
    get() = ParameterlessBuilder("java_iden")

// -------------------------------------------------------------------------------------------------

val ascii_java_iden
    get() = ParameterlessBuilder("ascii_java_iden")
